	...
	<div class="row card-grid">
		<div class="card-grid-item col-lg-<?= $col_lg_width; ?> col-md-6 col-sm-12">
			<article class="card intro-card">
				...
				?>
				<div class="card-body-wrapper webp-fallback" style="background-image: url('<?= $img1->optimizedUrl(true); ?>');" aria-label="<?= rex_escape($img1->altText()); ?>" data-webp-fallback="<?= $img1->url(); ?>">
					<div class="card-body">
		...
		<div class="card-grid-item col-lg-<?= $col_lg_width; ?> col-md-6 col-sm-12">
			<article class="card intro-card">
				...
				?>
				<div class="card-body-wrapper webp-fallback" style="background-image: url('<?= $img2->optimizedUrl(true); ?>');" aria-label="<?= rex_escape($img2->altText()); ?>" data-webp-fallback="<?= $img2->url(); ?>">
					<div class="card-body">
		...
		<div class="card-grid-item col-lg-<?= $col_lg_width; ?> col-md-6 col-sm-12">
			<article class="card intro-card">
				...
				?>
				<div class="card-body-wrapper webp-fallback" style="background-image: url('<?= $img3->optimizedUrl(true); ?>');" aria-label="<?= rex_escape($img3->altText()); ?>" data-webp-fallback="<?= $img3->url(); ?>">
					<div class="card-body">
		...
		<div class="card-grid-item col-lg-<?= $col_lg_width; ?> col-md-6 col-sm-12">
			<article class="card intro-card">
				...
				?>
				<div class="card-body-wrapper webp-fallback" style="background-image: url('<?= $img4->optimizedUrl(true); ?>');" aria-label="<?= rex_escape($img4->altText()); ?>" data-webp-fallback="<?= $img4->url(); ?>">
					<div class="card-body">
